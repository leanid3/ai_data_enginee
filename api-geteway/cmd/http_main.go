...
type AnalyzeResponse struct {
	...
	Status          string                 `json:"status"`
	DataProfile     map[string]interface{} `json:"data_profile"`
...
func NewAPIGateway() *APIGateway {
	return &APIGateway{
		...
		ChatServiceURL:          "http://chat-service:50055",
		LLMServiceURL:           "http://llm-service:50056",
		OrchestrationServiceURL: "http://orchestration-service:50057",
...
func main() {
	...
	http.HandleFunc("/api/v1/dialogs", gw.CreateDialog)
	http.HandleFunc("/api/v1/analyze", gw.AnalyzeData)
	http.HandleFunc("/api/v1/generate-ddl", gw.GenerateDDL)
